...
# Dialogs
var first_dialog = preload("res://Buildng Powering Puzzle/Verification/Test/Dialogs/FirstDialog.tres")
var in_puzzle_dialog = preload("res://Buildng Powering Puzzle/Verification/Test/Dialogs/InPuzzleDialog.tres")
var verified_yes = preload("res://Buildng Powering Puzzle/Verification/Test/Dialogs/PuzzleVerifiedYes.tres")
var verified_no = preload("res://Buildng Powering Puzzle/Verification/Test/Dialogs/PuzzleVerifiedNo.tres")
var puzzle_completed = preload("res://Buildng Powering Puzzle/Verification/Test/Dialogs/PuzzleCompleted.tres")
