...
# Dialogs
var first_dialog = preload("res://Santa Claus/NP/Level 3/Dialogs/FirstDialog.tres")
var puzzle_instr = preload("res://Santa Claus/NP/Level 3/Dialogs/PuzzleInstructions.tres")
var in_puzzle_dialog = preload("res://Santa Claus/NP/Level 3/Dialogs/InPuzzleDialog.tres")
var puzzle_yes_correct = preload("res://Santa Claus/NP/Level 3/Dialogs/PuzzleYesCorrect.tres")
var puzzle_yes_wrong = preload("res://Santa Claus/NP/Level 3/Dialogs/PuzzleYesWrong.tres")
var puzzle_yes_none = preload("res://Santa Claus/NP/Level 3/Dialogs/PuzzleYesNone.tres")
var puzzle_no_correct = preload("res://Santa Claus/NP/Level 3/Dialogs/PuzzleNoCorrect.tres")
var puzzle_no_wrong = preload("res://Santa Claus/NP/Level 3/Dialogs/PuzzleNoWrong.tres")
var puzzle_giveup = preload("res://Santa Claus/NP/Level 3/Dialogs/PuzzleGiveup.tres")
var puzzle_solved = preload("res://Santa Claus/NP/Level 3/Dialogs/PuzzleSolved.tres")
var to_verification = preload("res://Santa Claus/NP/Level 3/Dialogs/ToVerification.tres")


var complete: bool = false
var current_dialog = first_dialog
#Stores index values of each gift assigned to each child
var preset_certificate = [[1, 2], [3, 4], [5], [6], [7]]
...
func in_puzzle_yes():
	...
	ProgressData.level_lost_last[ProgressData.puzzle_types.SantaClausPuzzle] = 3
	...
	if not (3 in ProgressData.santa_claus_vf_levels_unlocked):
		ProgressData.santa_claus_vf_levels_unlocked.append(3)
